    ...
    <div className="flex justify-around items-center flex-1 p-2">
      <div className="flex flex-col gap-2">
        <div className="flex">
          ...
          <a href={`/pokemon/rufflet`} className="z-1">
            <Image
              alt=""
              width={96}
              height={96}
              src="/sprites/Standart/normal/627.png"
            />
          </a>
        </div>
      </div>
      ...
      <div className="flex flex-col gap-2">
        <div className="flex">
          <div className="w-[96px] h-[96px] bg-white/5 rounded-full z-0 absolute"></div>
          <a href={`/pokemon/braviary`} className="z-1">
            <Image
              alt=""
              width={96}
              height={96}
              src="/sprites/Standart/normal/628.png"
            />
          </a>
        </div>
        ...
        <div className="flex">
          ...
          <a href={`/pokemon/braviary`} className="z-1">
            <Image
              ...
              width={96}
              height={96}
              src="/sprites/Hisuian/normal/628-hisuian.png"
            />
          </a>
        </div>
      </div>
