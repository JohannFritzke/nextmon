    ...
    <div className="flex justify-around items-center flex-1 p-2">
      <div className="flex flex-col gap-2">
        <div className="flex">
          ...
          <a href={`/pokemon/exeggcute`} className="z-1">
            <Image
              alt=""
              width={96}
              height={96}
              src="/sprites/Standart/normal/102.png"
            />
          </a>
        </div>
      </div>
      ...
      <div className="flex flex-col gap-2">
        <div className="flex">
          <div className="w-[96px] h-[96px] bg-white/5 rounded-full z-0 absolute"></div>
          <a href={`/pokemon/exeggutor`} className="z-1">
            <Image
              alt=""
              width={96}
              height={96}
              src="/sprites/Standart/normal/103.png"
            />
          </a>
        </div>
        ...
        <div className="flex">
          ...
          <a href={`/pokemon/exeggutor`} className="z-1">
            <Image
              ...
              width={96}
              height={96}
              src="/sprites/Alolan/normal/103-alola.png"
            />
          </a>
        </div>
      </div>
